...
Uses async engine from app.db.session for online migrations.
Reads DB URI from app.config.
"""
...
# Import Base which imports all models for autogenerate
...
from app.db.models.memory import Memory  # noqa: F401
